...
go			--����Ա��Ϣ������¼�Ĵ洢����
create procedure new_bus (@bus_no varchar(10),@time_s time,@time_e time,@time_l time) as insert into [dbo].[Bus_information] values(@bus_no,@time_s,@time_e,@time_l)
go			--������Ϣ������¼�Ĵ洢����
...
go			--��Ӽƻ��Ĵ洢����
create procedure new_sid (@bus_no varchar(10),@station_id char(10),@license_p varchar(9),@engine_s time,@gps text,@carout_date date,@line_layer int)
